...
Aqui também você vai observar que o usuário via digitar uma sequência de números, e enquanto não for negativo esses numeros serão somados;
No final do programa o programa irá mostrar a a média de todas as idade digitadas.
